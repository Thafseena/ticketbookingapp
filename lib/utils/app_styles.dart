...
class Styles{
  ...
  static TextStyle headLineStyle2= TextStyle(fontSize:18 ,color: textColor,fontWeight: FontWeight.bold);
  static TextStyle headLineStyle3= TextStyle(fontSize:13 ,fontWeight: FontWeight.w500);
  static TextStyle headLineStyle4= TextStyle(fontSize:12 ,color:Colors.grey.shade500 ,fontWeight:FontWeight.w500);
}