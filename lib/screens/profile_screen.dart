    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text("Book Tickets",style: Styles.headLineStyle.copyWith(fontSize:22 ),),
                ...
                top: -40,
                 child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    shape: BoxShape.circle,
                    border: Border.all(width: 16,color:Color(0xFF264CD2), ),
                  ),
                 ),
               ),
               Container(
                padding: EdgeInsets.symmetric(horizontal: AppLayout.getHeight(25),vertical: AppLayout.getWidth(20)),
                 child: Row(
                   mainAxisAlignment: MainAxisAlignment.start,
          ...
          Container(
            padding: EdgeInsets.symmetric(horizontal: AppLayout.getHeight(14)),
            decoration: BoxDecoration(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("16 jan 2023",style: Styles.headLineStyle4.copyWith(fontSize: 16),),
                  ],
                ),
